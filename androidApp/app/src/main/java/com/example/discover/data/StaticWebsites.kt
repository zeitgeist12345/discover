...
object StaticWebsites {
    val websites = listOf(
        ...
        Link(
            ...
            tags = listOf("cool", "awesome", "wow", "beautiful"),
            views = 33,
            likesMobile = 3,
            dislikesMobile = 0
        ),
        ...
        Link(
            ...
            tags = listOf("systemdesign", "course", "learning"),
            views = 1,
            likesMobile = 0,
            dislikesMobile = 0
        ),
        ...
        Link(
            ...
            description = "A Visual and Intuitive Guide",
            tags = listOf("llm", "ai", "explained"),
            views = 1,
            likesMobile = 0,
            dislikesMobile = 0
        ),
