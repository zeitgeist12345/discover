...
object StaticLinks {
    val links = listOf(
        ...
        Link(
            ...
            tags = listOf("curated", "sample", "positive"),
            views = 183,
            likesMobile = 2,
            dislikesMobile = 0
        ),
        ...
        Link(
            ...
            tags = listOf("math", "cs", "coding", "positive"),
            views = 120,
            likesMobile = 5,
            dislikesMobile = 0
        ),
        ...
        Link(
            ...
            tags = listOf("buy", "brands", "ethics", "positive"),
            views = 1,
            likesMobile = 0,
            dislikesMobile = 0
        ),
        ...
        Link(
            ...
            tags = listOf("fifa", "worldcup", "sports", "positive"),
            views = 20,
            likesMobile = 0,
            dislikesMobile = 0
        ),
        ...
        Link(
            ...
            tags = listOf("positive", "fifa", "sports"),
            views = 18,
            likesMobile = 0,
            dislikesMobile = 0
        ),
        ...
        Link(
            ...
            tags = listOf("fifa", "worldcup", "canadamexicousa2026", "positive"),
            views = 19,
            likesMobile = 0,
            dislikesMobile = 0
        ),
        ...
        Link(
            ...
            tags = listOf("positive", "law", "usa", "injustice", "incompetence", "evil"),
            views = 1,
            likesMobile = 0,
            dislikesMobile = 0
        ),
